...
//汇率管理
const getCurrencyList = params => postAction('/api/login/payCurrencyType/getCurrencyTypeList', params);
const addCurrency = params => postAction('/api/login/payCurrencyType/add', params);
const editCurrency = params => postAction('/api/login/payCurrencyType/update', params);
const deleteCurrency = params => deleteAction('', params); // waiting for API
const getRateList = params => postAction('/api/login/payCurrencyRate/getCurrencyRateList', params);
const addRate = params => postAction('/api/login/payCurrencyRate/add', params);
const editRate = params => putAction('', params); // waiting for API
const deleteRate = params => deleteAction('', params); // waiting for API
const batchDelCurrency = params => postAction('', params); // waiting for API
const batchCurrencyStatus = params => postAction('', params); // waiting for API
const batchDelRate = params => postAction('', params); // waiting for API
const batchRateStatus = params => postAction('', params); // waiting for API
const checkCurrencyName = params => postAction('', params); // waiting for API
const checkRateName = params => postAction('', params); // waiting for API
