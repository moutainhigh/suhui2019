<template>
  ...
  >
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item label="商户账号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input
            placeholder="请输入商户账号"
        ...
        <a-form-item label="应用名" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入应用名" v-decorator="['realname', validatorRules.realname]" />
        </a-form-item>
        ...
        <a-form-item label="平台费率" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入平台费率" v-decorator="['email', validatorRules.email]" />
        </a-form-item>
        <a-form-item label="用户费率" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入用户费率" v-decorator="['email', validatorRules.email]" />
        </a-form-item>
